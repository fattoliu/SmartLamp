...
import com.fatto.mpandroidchart.formatter.DefaultFillFormatter;
import com.fatto.mpandroidchart.formatter.IFillFormatter;
...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    /**
     * List representing all color that are used for the circles
     */
    ...
    /**
     * returns all color specified for the circles
     *
     * @return
     */
    ...
    /**
     * Sets the color that should be used for the circles of this DataSet.
     * Colors are reused as soon as the number of Entries the DataSet represents
     * is higher than the size of the color array. Make sure that the color
    ...
    /**
     * ets the color that should be used for the circles of this DataSet.
     * Colors are reused as soon as the number of Entries the DataSet represents
     * is higher than the size of the color array. You can use
     * "new String[] { R.color.red, R.color.green, ... }" to provide color for
    ...
    /**
     * resets the circle-color array and creates a new one
     */
