package com.fatto.mpandroidchart.data;
...
import com.fatto.mpandroidchart.utils.ColorTemplate;
...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    /**
     * List representing all color that are used for this DataSet
     */
    protected List<Integer> mColors = null;

    /**
     * List representing all color that are used for drawing the actual values for this DataSet
     */
    ...
    /**
     * Sets the color that should be used fore this DataSet. Colors are reused
     * as soon as the number of Entries the DataSet represents is higher than
     * the size of the color array. If you are using color from the resources,
     * make sure that the color are already prepared (by calling
     ...
     * Sets the color that should be used fore this DataSet. Colors are reused
     * as soon as the number of Entries the DataSet represents is higher than
     * the size of the color array. You can use
     * "new int[] { R.color.red, R.color.green, ... }" to provide color for
     * this method. Internally, the color are resolved using
    ...
    /**
     * Adds a new color to the color array of the DataSet.
     *
     * @param color
     */
     ...
     * Internally, this recreates the color array and adds the specified color.
     *
     * @param color
     */
    ...
    /**
     * Sets color with a specific alpha value.
     *
     * @param colors
     * @param alpha
     */
    ...
    /**
     * Resets all color of this DataSet and recreates the color array.
     */
