...
package com.fatto.mpandroidchart.renderer;
...
import com.fatto.mpandroidchart.components.LegendEntry;
import com.fatto.mpandroidchart.data.ChartData;
import com.fatto.mpandroidchart.interfaces.datasets.IBarDataSet;
import com.fatto.mpandroidchart.interfaces.datasets.ICandleDataSet;
import com.fatto.mpandroidchart.interfaces.datasets.IDataSet;
import com.fatto.mpandroidchart.interfaces.datasets.IPieDataSet;
import com.fatto.mpandroidchart.utils.ColorTemplate;
import com.fatto.mpandroidchart.utils.FSize;
...
public class LegendRenderer extends Renderer {
    ...
    /**
     * Prepares the legend and calculates all needed forms, labels and color.
     *
     * @param data
     */
    public void computeLegend(ChartData<?> data) {
        ...
        if (!mLegend.isLegendCustom()) {
            ...
            // loop for building up the color and labels used in the legend
            for (int i = 0; i < data.getDataSetCount(); i++) {
                ...
                if (dataSet instanceof IBarDataSet && ((IBarDataSet) dataSet).isStacked()) {
                    ...
                    for (int j = 0; j < clrs.size() && j < entryCount; j++) {
                        ...
                        // if multiple color are set for a DataSet, group them
