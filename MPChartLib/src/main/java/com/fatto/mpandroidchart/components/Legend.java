...
package com.fatto.mpandroidchart.components;
 ...
 * per color and DataSet. Multiple color in one DataSet are grouped together.
...
public class Legend extends ComponentBase {
    ...
    /**
     * Are the legend labels/color a custom value or auto calculated? If false,
    ...
    /**
     * the shape/form the legend color are drawn in
     */
    ...
    public Legend(int[] colors, String[] labels) {
        ...
        if (colors == null || labels == null) {
            throw new IllegalArgumentException("color array or labels array is NULL");
        }

        if (colors.length != labels.length) {
            throw new IllegalArgumentException(
                    "color array and labels array need to be of same size");
        }
    ...
    /**
     * This method sets the automatically computed color for the legend. Use setCustom(...) to set custom color.
     *
     * @param entries
     */
