...
package com.fatto.mpandroidchart.utils;
 ...
 * ColorTemplate.VORDIPLOM_COLORS) and convenience methods for loading color
 * from resources.
 *
...
public class ColorTemplate {
    ...
    /**
     * turn an array of resource-color (contains resource-id integers) into an
     * array list of actual color integers
     *
     * @param r
     * @param colors an integer array of resource id's of color
     * @return
     */
    ...
    /**
     * Turns an array of color (integer color values) into an ArrayList of
     * color.
     *
     * @param colors
     * @return
