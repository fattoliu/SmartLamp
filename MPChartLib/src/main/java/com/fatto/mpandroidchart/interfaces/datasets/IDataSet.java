package com.fatto.mpandroidchart.interfaces.datasets;
...
import com.fatto.mpandroidchart.data.DataSet;
...
public interface IDataSet<T extends Entry> {
    ...
    /**
     * returns all the color that are set for this DataSet
     *
     * @return
     */
    ...
    /**
     * Returns the first color (index 0) of the color-array this DataSet
     * contains. This is only used for performance reasons when only one color is in the color array (size == 1)
     *
     * @return
     */
    int getColor();
    ...
    /**
     * Sets a list of color to be used as the color for the drawn values.
     *
     * @param colors
     */
    ...
    /**
     * Returns only the first color of all color that are set to be used for the values.
     *
     * @return
     */
